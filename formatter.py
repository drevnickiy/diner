...
function renderVotes(votes, summary) {{
    ...
    votes.forEach(v => {{
        ...
        const carStr = (isGoing && v.car && v.car !== 'Без авто') ? `<span style="background: #eff6ff; border: 1px solid #93c5fd; border-radius: 6px; padding: 2px 6px; font-size: 11px; color: #1e40af; font-weight: 700; margin-left: 4px;">${{getCarBadge(v.car)}}</span>` : '';
